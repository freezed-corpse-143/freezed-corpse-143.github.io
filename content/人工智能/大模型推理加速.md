...
$$
\mu_{b, d}={1\over n}\sum_{i=1}^n X_{b,i,d}
$$

再求方差：

$$
\sigma_{b,d}^2 ={1\over n}\sum_{i=1}^n (X_{b,i,d}-\mu_{b,d})^2
$$

归一化

$$
\hat{X}_{b,i,d}={X_{b,i,d}-\mu_{b,d}\over \sqrt{\sigma^2_{b,d}+\epsilon}}
$$

仿射变换

$$
Y_{b,i,d}=\gamma_d \hat{X}_{b,i,d}+\beta_d
$$
...
$$
A_i =softmax\left({Q_iK_i^T}\over \sqrt{d_k} \right)
$$

- $Q_iK_iT\in \mathbb{R}^{b\times n \times n}$，softmax 是在最后一个为 du